using AetherChannel.Plugin.Video;
...
public sealed class Plugin : IDalamudPlugin
{
    ...
    private readonly WindowSystem windowSystem = new("AetherChannel");
    ...
    public string Name => "AetherChannel";
    ...
    public Plugin()
    {
        ...
        {
            HelpMessage = "Open the AetherChannel window.",
        });
    }
    ...
    // An admin cleared this player's name server-side (see AetherChannel.Server's
    ...
    private void OnRemoteState(AetherChannel.Contracts.StreamControl message)
    {
